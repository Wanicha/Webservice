...
$strMode = $_POST["aMode"];
$detail = rudeword($_REQUEST['aDetail']);
$name = $_REQUEST['aName'];
$strID = $_REQUEST["bID"];
...
if ($strMode == "ADD")
{
 ...
 AS datepost FROM tbl_comment WHERE ref_blog_id='$strID' ORDER BY comment_id DESC");
 ...
 ?>
        ...
        <table width="90%" border="0" cellspacing="3" cellpadding="0">
         <tr>
            <td rowspan="2"><span class="answer"><b><?=$name;?></b></span>
        <font style="color:#666">แสดงความคิดเห็น : <span class="date"><?=$date_post;?></span><br/><br/>
        <?=$detail;?><font></td>
         </tr>
<?
...
?>
        <tr>
            <td align="right"><img src="" border="0" width="20" height="20" onClick="doDelete('DELETE','<?=$strID;?>','<?=$cid;?>')"/></td>
            </tr>
<? } ?>
        </table>
        </div>
